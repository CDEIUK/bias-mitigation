...
<PlotLoader source={"finance/interventions/agarwal-eo.json"} />
...
<PlotLoader source={"finance/interventions/agarwal-eopp.json"} />
...
<PlotLoader source={"recruiting/interventions/agarwal-eo.json"} />
