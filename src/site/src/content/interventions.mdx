...
The reduction in equalised odds is more significant, reducting equalised odds difference from 0.128 to 0.074. Further details on mean scores are displayed in two graphs below which compare Fairness Through Unawareness and baseline.
...
Similar to our experiments on the adult data, Fairness Through Unawareness has reduced the level of calibratino compared to the baseline model.
