...
CDEI is the data controller for pages starting with [cdeiuk.github.io][cdeiuk-gh-pages] - for example, [cdeiuk.github.io/bias-mitigation][bias-mitigation].
...
CDEI does not directly collect any personal information, but we do use Google Analytics software to collect information about how you use this website. This includes IP addresses, which are anonymised before being used for analytics processing.
