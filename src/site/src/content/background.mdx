...
The application of PETs is highly context-specific, and our research has found that increasing awareness and understanding of PETs could foster greater adoption of the technologies. The [PETs adoption guide](/adoption-guide) aims to help bridge this gap, posing questions to help technologists working on initiatives involving sensitive information consider which PETs could be useful to them. The guide aims not to be overly prescriptive, but rather provides pointers to relevant resources and [use cases from the repository](/repository) that may support decision-making.
