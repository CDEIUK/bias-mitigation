...
We will start by introducing the two data sets that will be used throughout to compare the different interventions, the first data set for [finance](finance), the second for [recruiting](recruiting). An important caveat for the first of these (the Adult Data Set) is that it is drawn from the US Census, and includes legacy categories for ethnic background that are now inappropriate. The graphs shown here are built automatically from that data. Where "American Indian / Eskimo" appears, the correct terms would be Indigenous peoples, American Indian, Native American, or Alaska Native, depending on context.

An important caveat for the first of these (the Adult Data Set) is that it is drawn from the US Census, and includes legacy categories for ethnic background that are now inappropriate. The graphs shown here are built automatically from that data. Where "American Indian / Eskimo" appears, the correct terms would be Indigenous peoples, American Indian, Native American, or Alaska Native, depending on context.
