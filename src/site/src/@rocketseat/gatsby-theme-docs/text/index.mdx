...
We will start by introducing the two data sets that will be used throughout to compare the different interventions, the first data set for [finance](finance), the second for [recruiting](recruiting).
