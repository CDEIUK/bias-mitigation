...
previous: data
previousLabel: The Adult data set
---

import { LazyPlot } from "../../components/myplotly"

import dp_by_race from "../../figures/finance_dp_by_race.json"
import dp_by_sex from "../../figures/finance_dp_by_sex.json"
import cdp_by_race from "../../figures/finance_cdp_by_race.json"
import cdp_by_sex from "../../figures/finance_cdp_by_sex.json"
import eo_by_race from "../../figures/finance_eo_by_race.json"
import eo_by_sex from "../../figures/finance_eo_by_sex.json"

We start by training a simple model on the data, specifically a shallow, feed-forward neural network. You can see the details here **ADD NOTEBOOK LINK**. To understand the possible sources of bias in our model, it's useful to first train a model with no attempted mitigation, and understand the resulting unfairness.
